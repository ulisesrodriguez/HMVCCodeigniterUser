...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <h4><?php echo $this->lang->line( 'title_update' ); ?></h4>
      ...
      <?php echo form_open_multipart( '', array( 'id' => 'form_' )); ?>
            ...
            <?php 
                  ...
                  echo form_input(												
                      array(
                        'name'        => 'name',
                        'id'          => 'name',
                        'value'       => set_value( 'name', $data[0]['name'] ),
                        'maxlength'   => '40',
            ...
            <?php 
                  ...
                  echo form_input(												
                      array(
                        'name'        => 'email',
                        'id'          => 'email',
                        'value'       => set_value('email' , $data[0]['email']),
                        'maxlength'   => '150',
            ...
            <?php 
                  ...
                  echo form_input(												
                      array(
                        'name'        => 'address',
                        'id'          => 'address',
                        'value'       => set_value('address', $data[0]['address']),
                        'maxlength'   => '250',
            ...
            <?php 
                  ...
                  echo form_input(												
                      array(
                        'name'        => 'phone',
                        'id'          => 'phone',
                        'value'       => set_value('phone', $data[0]['phone']),
                        'maxlength'   => '20',
            ...
            <?php 
                  ...
                  echo form_textarea(												
                      array(
                        'name'        => 'comments',
                        'id'          => 'comments',
                        'value'       => set_value('comments', $data[0]['comments']),
       ...
       <fieldset>
          <legend><?php echo $this->lang->line( 'form_legend_login' ); ?></legend>
           ...
           <label><?php echo $this->lang->line( 'form_user' ); ?></label>
            ...
            <?php 
                  ...
                  echo form_input(												
                      array(
                        'name'        => 'user',
                        'id'          => 'user',
                        'value'       => set_value('user', $data[0]['user']),
                        'maxlength'   => '20',
            ...
            <img src="<?php echo base_url() ?>user/assets/images/<?php echo $data[0]['img'] ?>" width="50" height="50">
